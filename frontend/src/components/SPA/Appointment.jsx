  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios.post("http://localhost:5555/noti", {
        ...
        status: "unread",
        description: `Your Ayurwedi Spa Package has been addded`,
        topic: "spa",
        userID: userId,
      });
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#fcecae]">
      <div className="max-w-xl w-full px-6 py-4 shadow-2xl bg-white rounded overflow-hidden">
        <br />
        <h4 className="text-3xl font-mono antialiased text-gray-800 mb-2 font-semibold text-center">
          Ayurvedic SPA Service Appointment
        </h4>
        <br />
        <div className="max-w-xl rounded overflow-hidden shadow-lg bg-green-200 p-6">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              >
                ...
                <option value="SAMVAHANA">SAMVAHANA</option>
                <option value="SHIRSHABYANGA">SHIRSHABYANGA</option>
