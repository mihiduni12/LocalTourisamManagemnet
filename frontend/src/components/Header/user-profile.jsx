      ...
      <div className="flex pt-[40px] ml-[20px]">
        ...
        <div className="w-[310px] h-[1400px] mr-[10px] border border-[#d3d3d3] rounded-[14px] bg-[#ffffff]">
          ...
          <div className="border border-[#969696] py-[6px] pb-[15px] mt-[110px] mx-[20px] rounded-[11px]">
           ...
           <Link to='/noti'><div className="mx-auto mt-[5px] py-[11px] pl-[20px] w-[240px] rounded-[8px] bg-[#ffffff] text-[#414141] text-[14pt] hover:bg-[#dedede]"><i class="fa-duotone fa-envelope mr-[18px] ml-[-1px] pt-[5px] text-[17pt]" style={{"--fa-primary-color": "#d3bf05", "--fa-secondary-color": "#d3bf05",}} />Notifications</div></Link> 
